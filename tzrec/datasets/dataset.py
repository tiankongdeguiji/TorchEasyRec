...
from tzrec.prompt.assembler import ATTACH_POSITIONS, OUTPUT_KEYS, PromptAssembler
...
class BaseDataset(IterableDataset, metaclass=_dataset_meta_cls):
    ...
    def _build_batch(self, input_data: Dict[str, pa.Array]) -> Batch:
        ...
        if self._prompt_assembler is not None:
            ...
            if ATTACH_POSITIONS in streams:
                batch.additional_infos[ATTACH_POSITIONS] = streams[ATTACH_POSITIONS]
